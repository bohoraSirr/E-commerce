...
const CartDrawer = ({ drawerOpen, toggleCartDrawer }) => {
  return (
    ...
    md:w-[30rem] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${drawerOpen ? "translate-x-0" : "translate-x-full"}`}
    >
      {/* Close Button */}
      ...
      <div className="p-4 bg-white sticky bottom">
        ...
        <p className="text-center text-sm tracking-tighter text-gray-500 mt-2">
